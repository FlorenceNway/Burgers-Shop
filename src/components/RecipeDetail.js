    ...
    return  <div className="recipeDetail">
                <div className={'recipe'}>
                    <div className='detail'>
                        <h3>{recipe.title}</h3>
                        <p><img src={require('../images/clock.svg')}></img>{recipe.time}</p>
                        <div>
                            <p><img src={require('../images/clock.svg')}>{recipe.serving}</img></p>
                            <p><img src={require('../images/clock.svg')}></img>820 cals/serving</p>
                        </div>
